...
// _mock_
import { _images } from '../../../_mock/arrays';
// @types
...
Gallery.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function Gallery() {
  ...
  const [tableData, setTableData] = useState(_images);
